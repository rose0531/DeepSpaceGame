...
public class EnemySettings : ScriptableObject {
    ...
    public float TurnTimer = 8f;                    // Timer to turn the player after not colliding with anything.
    ...
    public float AgroMaxDistance = 9f;              // Max agro distance the player has to escape for the enemy to stop agroing.
